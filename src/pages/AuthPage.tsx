...
export default function AuthPage() {
  useDocumentMeta({ title: "Sign In | More.ad", description: "Sign in or create an account to start generating AI-powered ad copy.", ogUrl: "https://more-ad.lovable.app/auth" });
